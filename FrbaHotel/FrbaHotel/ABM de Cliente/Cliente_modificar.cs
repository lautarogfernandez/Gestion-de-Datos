...
namespace FrbaHotel.ABM_de_Cliente
{
 ...
 List<Label> _cabecera = new List<Label>();
        ...
        public Cliente_modificar(DataGridViewSelectedCellCollection _camposElegidos,DataGridViewColumnCollection _columnas,string _nombreTabla)
        {
            InitializeComponent();
            ...
            for (int i = 0; i < _camposElegidos.Count; i++)
            {
                ...
                label2.Text = _camposElegidos[i].Value.GetType().ToString();
